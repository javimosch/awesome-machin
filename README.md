...
- **[machin-demo-cyberpunk](https://github.com/javimosch/machin-demo-cyberpunk)** — an **infinite procedural planet you fly through**: endless `noise2`/fbm wasteland terrain streamed in GPU-mesh chunks around a WASD+mouse fly camera, with Blade-Runner neon megastructures and a hazy sky. Drove machin's **`noise` builtins** (v0.49.0) and composes the whole stack — Perlin noise, native math, nested `Camera3D`, and the pointer/array FFI GPU meshes. The Tier-3 "procedural worlds" step.
